...
Original file is located at
    https://colab.research.google.com/drive/1-ZN_e0mu2MZUWSqvXriMBxF4ONxG-hZr

## Results of the Gender classification based on different classification algorithms
"""
